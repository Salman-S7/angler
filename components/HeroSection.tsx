...
const HeroSection = () => {
  ...
  return (
    <div className="h-[100dvh] flex justify-center items-center px-4 flex-col gap-[4%]">
      ...
      <div className="sm:text-6xl text-3xl font-bold text-center mx-auto text-white dark:text-neutral-400">
        ...
        <p className="sm:text-4xl text-xl font-light sm:px-16">
          ...
          <span className="text-sky-400"> more sales.</span>
        </p>
      </div>
